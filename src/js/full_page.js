function fullPage(mainClass, firstClass, num) {
			...
			var jianh = document.getElementById('myimg').clientHeight;

			var zhi = (height*0.3)/2;
			document.getElementById('index_h1').style.lineHeight = zhi+'px';
			document.getElementById('index_h2').style.lineHeight = zhi+'px';
			document.getElementById('index_h3').style.lineHeight = zhi+'px';
			//document.getElementById('myimg').style.marginTop=zhi+'px';
